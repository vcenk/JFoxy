...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Practice interviews with AI and get instant, personalized feedback.',
    type: 'website',
  },
}
...
const features = [
  {
    ...
    description: 'Industry-specific behavioral, situational, and competency-based questions used by top companies.',
  },
  {
    icon: BarChart3,
    title: 'Instant Feedback',
    description: 'Get detailed analysis of your answers including STAR structure, clarity, and impact.',
  },
  {
    icon: Clock,
    title: 'Practice Anytime',
    description: 'Available 24/7. Practice at 2 AM or during your lunch break—the AI is always ready.',
  },
  {
    icon: Target,
    title: 'Personalized Focus',
    description: 'Target specific roles, industries, or question types based on your interview goals.',
  },
  {
    icon: Sparkles,
    title: 'AI-Powered Insights',
    description: 'Advanced language analysis identifies patterns and suggests specific improvements.',
  },
  {
    icon: Brain,
    title: 'Progress Tracking',
    description: 'See your improvement over time with detailed metrics and performance trends.',
  },
]
...
const howItWorks = [
  {
    ...
    description: 'Select your target role, industry, and the type of questions you want to practice.',
  },
  {
    step: 2,
    title: 'Answer Questions',
    description: 'Respond to realistic interview questions just like in a real interview setting.',
  },
  {
    step: 3,
    title: 'Get Feedback',
...
const faqs = [
  {
    ...
    answer:
      'Our AI interviewer presents realistic questions based on your target role and industry. You type or speak your answers, and the AI analyzes your response for structure, clarity, specificity, and impact. You receive instant feedback with specific suggestions for improvement.',
  },
  {
    question: 'Is AI practice as effective as practicing with a real person?',
    answer:
      'Studies show AI mock interviews are highly effective for skill building. They offer unlimited practice, consistent feedback, and no scheduling constraints. For best results, we recommend combining AI practice with occasional human practice sessions before your actual interview.',
  },
  {
    question: 'What types of interviews can I practice for?',
    answer:
      'We support behavioral interviews, situational interviews, competency-based interviews, and general professional interviews across all industries. Whether you\'re interviewing for tech, finance, healthcare, or any other field, we have relevant questions.',
  },
  {
    question: 'How many practice sessions do I need?',
    answer:
      'Most users see significant improvement after 5-10 practice sessions. We recommend practicing regularly in the weeks leading up to your interview, with more intensive sessions in the final days before the real thing.',
  },
  {
    question: 'Can the AI help me if I struggle with a specific type of question?',
    answer:
      'Absolutely! The AI identifies patterns in your responses and provides targeted coaching. If you consistently struggle with "failure" questions or quantifying results, the system will offer specific techniques and examples to improve.',
  },
]
    ...
    <SEOPageLayout>
      ...
      <SEOPageHero
        ...
        stats={[
          ...
          { value: '1000+', label: 'Questions', color: 'text-blue-400' },
        ]}
        breadcrumbs={[
          { name: 'Home', href: '/' },
      ...
      <section id="how-it-works" className="py-16 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {howItWorks.map((item) => (
              <div key={item.step} className="text-center">
                <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-purple-500/20 to-violet-500/20 border border-purple-500/30 flex items-center justify-center">
          ...
          <div className="mt-12 text-center">
            <Link
              href="/auth/register"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-500 hover:to-violet-500 text-white font-semibold rounded-xl transition-all shadow-lg shadow-purple-500/25"
            >
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-white/80">Interview Confidence</span>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-white/80">Answer Structure</span>
                    <span className="text-purple-400 font-semibold">+60%</span>
                  </div>
                  <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full w-[90%] bg-gradient-to-r from-purple-500 to-violet-500 rounded-full" />
                  </div>
                </div>
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-white/80">Callback Rate</span>
                    <span className="text-blue-400 font-semibold">+35%</span>
                  </div>
                  <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                    <div className="h-full w-[75%] bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full" />
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 border-t border-white/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-4 gap-4 p-4 bg-white/5 border-b border-white/10 text-sm font-semibold text-white/80">
              <div>Feature</div>
            ...
            {[
              ...
              <div
                key={index}
                className="grid grid-cols-4 gap-4 p-4 border-b border-white/5 last:border-0"
              >
